...
class GoogleMapsConfig : AppAccessibilityConfig() {
    ...
    override fun findFirstFocusable(rootNode: AccessibilityNodeInfo): AccessibilityNodeInfo? {
        return rootNode.findAccessibilityNodeInfosByText("Search here").firstOrNull()
    }

    override fun findLastFocusable(rootNode: AccessibilityNodeInfo): AccessibilityNodeInfo? {
        return rootNode.findAccessibilityNodeInfosByText("Contribute").firstOrNull()
    }
